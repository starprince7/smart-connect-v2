...
export default function Header() {
  return (
    <header className="container">
      <div className="fixed top-[1.5%] left-2 sm:left-[13%] flex w-[96%] sm:w-[75%] border border-gray-700 p-2 bg-[#272a2aa8] backdrop-blur-xl backdrop-saturate-150 rounded-full mx-auto justify-between items-center">
