export default function Web3EarlyAccess({ handleIssuseSelect }) {
  return (
    <section className="container p-0 sm: pt-6">
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between gap-11 items-center border border-[#3b4040] p-2 sm:p-10 md:py-24 h-auto lg:h-[680px] w-full rounded-[3.5rem] bg-gradient-to-r from-[#272a2a] to-[#141414]">
        ...
        <div className="">
          <img
            ...
            className="min-w-full md:min-w-[115%] lg:min-w-[130%]"
          />
        </div>
      </div>
    </section>
